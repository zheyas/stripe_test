...
class Discount(models.Model):
    ...
    percentage = models.DecimalField(max_digits=5, decimal_places=2, help_text="Скидка в %, например 10.00", default=0  )
